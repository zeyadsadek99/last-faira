...
.main_loader_wrapper.custom_loader {
...
.book .inner .middle {
  @apply w-8 h-3 border-[4px] border-[var(--color)] border-t-0 rounded-b-md translate-y-[2px];
}

.book ul {
  @apply m-0 p-0 list-none absolute left-1/2 top-0;
}
